    ...
    const onDrop = (acceptedFiles) => {
        ...
        reader.onload = () => {
            ...
            const parsed = rows.map(row => {
                const [name, course, email, date] = row.split(',').map(s => s.trim());
                if (name && course) return { name, course, email, date };
                    ...
                    <div>
                        <div className="bg-white p-6 rounded shadow mb-6">
                            ...
                            <div {...getRootProps()} className="border-2 border-dashed border-gray-300 rounded-lg p-12 text-center cursor-pointer hover:border-blue-500">
                                ...
                                <p className="text-sm text-gray-400 mt-2">Format: Name, Course, Email, Date</p>
                            </div>
